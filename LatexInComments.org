...
* TODO BUGS
** TODO [#A] (laic-create-overlays-from-comment-inside) fails if called on last comment block in a file
...
nil"
** TODO [#B] Foreground color is sometimes wrong
...
** TODO [#C] LaTeX text size is hardcoded
- Should adapt to font size I guess
