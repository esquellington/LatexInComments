...
** TODO Maybe example screenshot for the lulz (Gallery section at the end)
...
** TODO Could it be (shell-command) being much slower on windows??
- Try with EMPTY (shell-commnad)
** TODO Could it be MikTeX being slower thatn TexLive?
