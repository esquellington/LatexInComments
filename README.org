...
#+html: <p align="center"> <img src="laic_colorized.png" width="75%" alt="Screen capture of a short C++ function with default and colorized formulas."/> </p>
#+html: <p align="center"> A ludicrous example of colorized equations in C++ comments using the "xcolor" additional package</p>

TODO: additional command in preamble
