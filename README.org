...
#+html: <p align="center"> <img src="laic_colorized.png" alt="Screen capture of a short C++ function with default and colorized formulas."/> </p>

Using custom matth commands defined in customized *laic-user-preamble*:
#+html: <p align="center"> <img src="laic_user_preamble.png" width="95%" alt="Screen capture of a short C++ function using custom math command."/> </p>
