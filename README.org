...
- Should work with [[https://miktex.org/][MiKTeX]] and [[https://www.tug.org/mactex/][MacTeX]], but *dvipng* may need to be installed independently and program name customized (see [[Customization]]).
...
- *laic-extra-packages*: amsmath,amsfonts are included by default, additional packages can be added here
- *laic-output-dir* Temporary files are stored in the customizable  relative to current file path
