...
#+html: <p align="center"> <video width="75%" autoplay muted loop> <source src="laic_cpp_example.webm" type"video/webm"/> VIDEO??? </video> </p>

#+BEGIN_EXPORT html
<p align="center">
 <video width="75%" autoplay muted loop>
  <source src="laic_cpp_example.webm" type"video/webm"/>
  <img src="laic_cpp_screenshot.png"/>
  VIDEO???
 </video>
</p>
#+END_EXPORT
